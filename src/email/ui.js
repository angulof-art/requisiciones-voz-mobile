...
} from "./distribution.js?v=2.0.0-beta.5";
import { buildEmailPreview, escapeHtml } from "./preview.js?v=2.0.0-beta.5";
import {
...
} from "./api.js?v=2.0.0-beta.5";
import {
  EMAIL_PERMISSIONS,
  canManageEmailDistribution,
  hasEmailPermission
} from "./permissions.js?v=2.0.0-beta.5";
